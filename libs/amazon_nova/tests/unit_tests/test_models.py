...
class TestValidation:
    ...
    def test_validate_tool_calling_success(self):
    ...
    def test_validate_tool_calling_failure(self):
    ...
    def test_validate_image_generation_failure(self):
